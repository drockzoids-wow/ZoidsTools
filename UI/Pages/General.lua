...
function ns.UI.Pages.CreateGeneralPage(parent)
    ...
    local tooltipSection = UI.PlaceSection(frame, "Tooltips", cinematicAutoSkip, rightWidth)
    ...
    UI.PlaceFirst(tooltipBackground, tooltipSection)
    ...
    UI.PlaceBelow(tooltipScore, tooltipNames)
